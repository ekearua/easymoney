...
func TestServiceSwitchIntentCommands(t *testing.T) {
	...
	tests := []struct {
		...
		{input: "my limits", want: "my_details"},
		{input: "menu_my_limits", want: "my_details"},
		{input: "my details", want: "my_details"},
		{input: "menu_my_details", want: "my_details"},
		{input: "history", want: "my_details"},
		{input: "recent transactions", want: "my_details"},
