...
NEW_ROWS = [
    ...
    ("B1", "TestReconciliationThreeWay (bank-transfer draft driven to succeeded)", "store_integration_test.go:1409", "TEST_DATABASE_URL", "Bank-transfer success posts ledger money-in via the succeeded transition"),
    ("B2", "TestBankTransferExpiry_B2", "payment_expiry_test.go:93", "TEST_DATABASE_URL", "Unconfirmed bank-transfer draft expires; allowance released"),
